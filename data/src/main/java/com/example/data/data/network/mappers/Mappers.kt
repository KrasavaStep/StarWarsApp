...
fun PlanetDTO.mapToPlanet() = PlanetModel(
    id = convertToID(this.url),
    name = this.name,
    rotationPeriod = this.rotationPeriod.toInt(),
    orbitalPeriod = this.orbitalPeriod.toInt(),
    diameter = this.diameter.toInt(),
    climate = this.climate,
    gravity = this.gravity,
    terrain = this.terrain,
    surfaceWater = this.surfaceWater.toInt(),
    population = this.population.toInt(),
...
fun SpeciesDTO.mapToSpecies() = SpeciesModel(
    ...
    averageHeight = this.averageHeight.toInt(),
    skinColors = this.skinColors,
    hairColors = this.hairColors,
    eyeColors = this.eyeColors,
    avgLifespan = this.averageLifespan.toInt(),
    homeworld = convertToID(this.homeworld),
...
fun StarshipDTO.mapToStarship() = StarShipModel(
    ...
    length = this.length.toFloat(),
    maxSpeed = this.maxSpeed.toInt(),
    crew = this.crew.toInt(),
    passengers = this.passengers.toInt(),
    cargoCapacity = this.cargoCapacity.toInt(),
    consumables = this.consumables,
    hyperdriveRating = this.hyperdriveRating.toFloat(),
    mglt = this.mglt.toInt(),
