...
fun DeathStarLoader() {
    val loadingPhrases = listOf(
        stringResource(R.string.loader_label_1),
        stringResource(R.string.loader_label_2),
        stringResource(R.string.loader_label_3),
        stringResource(R.string.loader_label_4),
        stringResource(R.string.loader_label_5)
    )
